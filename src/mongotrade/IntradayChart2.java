...
public class IntradayChart2 {
    ...
    public static void main(String args[]) {
        ...
        BarArray ba = ml.getData("gspc", 12, "M15");
        ...
        //TranslatingDataset result = new TranslatingDataset("SP500", data);
        IntradayChart2 mychart = new IntradayChart2(dataset);
    }
    public IntradayChart2(OHLCDataset dataset)
    {
        ...
        plot.setBackgroundPaint(new GradientPaint(0, 0, Color.cyan, 200, 200, Color.blue, false));
...
/*
 ValueAxis yAxis = (ValueAxis) plot.getRangeAxis();
        ...
        xAxis.setTimeline(SegmentedTimeline.newFifteenMinuteTimeline().newMondayThroughFridayTimeline());
...
//        axis.setNumberFormatOverride(new TranslatingFormat((TranslatingDataset) plot.getDataset()));
